var JsonFormatter = function (options) {
  ...
  self.getFeature = function(event) {
    return getItem(self.allFeatures.features, event, 'feature', self.buildFeature);
  };

  self.getScenario = function(feature, event) {
    return getItem(feature.scenarios, event, 'scenario', self.buildScenario);
  };
